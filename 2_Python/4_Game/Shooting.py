...
screen_w = 480
screen_h = 640
screen = pygame.display.set_mode((screen_w, screen_h))      # always use width first in code
...
bullet_size = bullet.get_rect().size # [30, 30]
...
enemy_size = enemy.get_rect().size # [30, 30]
...
enemy_speed = random.randint(1, 2)      # 1 or 2 as speed
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:        # KEYDOWN = All keys
    ...
    bullets = [[b_pos[0], b_pos[1]] for b_pos in bullets if b_pos[1] < screen_h]    # erases bullets
